        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <div class="navbar-form navbar-right">
                    ...
                    <div style="color: #ffffff">Bonjour admin <?php echo $session_id; ?></div>
    ...
    <div class="container">
        ...
        <div class="masthead">
            <ul class="nav nav-justified">
                ...
                <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"> Produits <b
                            class="caret"></b> </a>
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo site_url('admin/produits_c/index/') ?>">Liste des produits</a></li>
                        <li><a href="<?php echo site_url('admin/produits_c/creer_produit/') ?>">Créer un produit</a>
                        </li>
                        <!--                    <li class="divider"></li>-->
                        <!--                    <li><a href="#">Autres</a></li>-->
                    </ul>
                </li>
                <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"> Commandes <b
                            class="caret"></b> </a>
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo site_url('admin/commandes_c/index/') ?>">Liste des Commandes</a></li>
                        <!--                    <li><a href="-->
                        <?php //echo site_url('admin/commandes_c/nouvelle_commande/') ?><!--">Passer une nouvelle commande</a></li>-->
                        <li class="divider"></li>
                        <li><a href="#">Autres</a></li>
                    </ul>
                </li>
                ...
                <!--                <ul class="dropdown-menu">-->
                <!--                    <li><a href="-->
                <?php //echo site_url('admin/produits_c/index/') ?><!--">Liste des produits</a></li>-->
                <!--                    <li><a href="-->
                <?php //echo site_url('admin/produits_c/creer_produit/') ?><!--">Créer un produit</a></li>-->
                <!--                    <li class="divider"></li>-->
                <!--                    <li><a href="#">Autres</a></li>-->
                <!--                </ul>-->
                <!--            </li>-->
                ...
                <!--            <li><a href="-->
                <?php //echo site_url('admin/commandes_c/nouvelle_commande/') ?><!--">Nouvelle commande</a></li>-->
